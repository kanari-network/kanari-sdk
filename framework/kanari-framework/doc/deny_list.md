...
<dd>
 ...
 For example with <code>kanari_framework::coin::Coin</code>: If addresses A and B are banned from using
...
<pre><code><b>fun</b> <a href="deny_list.md#0x2_deny_list_create">create</a>(ctx: &<b>mut</b> TxContext) {
    ...
    <b>let</b> deny_list_object = <a href="deny_list.md#0x2_deny_list_DenyList">DenyList</a> {
        id: <a href="object.md#0x2_object_kari_deny_list_object_id">object::kari_deny_list_object_id</a>(), // Fixed function name
        lists,
    };
