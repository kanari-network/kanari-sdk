...
<pre><code><b>const</b> <a href="type_name.md#0x1_type_name_ASCII_C">ASCII_C</a>: u8 = 99;
</code></pre>
...
<pre><code><b>const</b> <a href="type_name.md#0x1_type_name_ASCII_COLON">ASCII_COLON</a>: u8 = 58;
</code></pre>
...
<pre><code><b>const</b> <a href="type_name.md#0x1_type_name_ASCII_E">ASCII_E</a>: u8 = 101;
</code></pre>
...
<pre><code><b>const</b> <a href="type_name.md#0x1_type_name_ASCII_O">ASCII_O</a>: u8 = 111;
</code></pre>
...
<pre><code><b>const</b> <a href="type_name.md#0x1_type_name_ASCII_R">ASCII_R</a>: u8 = 114;
</code></pre>
...
<pre><code><b>const</b> <a href="type_name.md#0x1_type_name_ASCII_T">ASCII_T</a>: u8 = 116;
</code></pre>
...
<pre><code><b>const</b> <a href="type_name.md#0x1_type_name_ASCII_V">ASCII_V</a>: u8 = 118;
</code></pre>
...
<pre><code><b>const</b> <a href="type_name.md#0x1_type_name_ENonModuleType">ENonModuleType</a>: u64 = 0;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="type_name.md#0x1_type_name_is_primitive">is_primitive</a>(self: &<a href="type_name.md#0x1_type_name_TypeName">TypeName</a>): bool {
    <b>let</b> bytes = <a href="ascii.md#0x1_ascii_as_bytes">ascii::as_bytes</a>(&self.name);
    bytes == &b"bool" ||
    bytes == &b"u8" ||
    bytes == &b"u16" ||
    bytes == &b"u32" ||
    ...
    bytes == &b"u256" ||
    bytes == &b"<b>address</b>" ||
    (<a href="vector.md#0x1_vector_length">vector::length</a>(bytes) &gt;= 6 &&
    *<a href="vector.md#0x1_vector_borrow">vector::borrow</a>(bytes, 0) == <a href="type_name.md#0x1_type_name_ASCII_V">ASCII_V</a> &&
    *<a href="vector.md#0x1_vector_borrow">vector::borrow</a>(bytes, 1) == <a href="type_name.md#0x1_type_name_ASCII_E">ASCII_E</a> &&
    *<a href="vector.md#0x1_vector_borrow">vector::borrow</a>(bytes, 2) == <a href="type_name.md#0x1_type_name_ASCII_C">ASCII_C</a> &&
    *<a href="vector.md#0x1_vector_borrow">vector::borrow</a>(bytes, 3) == <a href="type_name.md#0x1_type_name_ASCII_T">ASCII_T</a> &&
    *<a href="vector.md#0x1_vector_borrow">vector::borrow</a>(bytes, 4) == <a href="type_name.md#0x1_type_name_ASCII_O">ASCII_O</a> &&
    *<a href="vector.md#0x1_vector_borrow">vector::borrow</a>(bytes, 5) == <a href="type_name.md#0x1_type_name_ASCII_R">ASCII_R</a>)
...
<pre><code><b>public</b> <b>fun</b> <a href="type_name.md#0x1_type_name_get_address">get_address</a>(self: &<a href="type_name.md#0x1_type_name_TypeName">TypeName</a>): String {
    <b>assert</b>!(!<a href="type_name.md#0x1_type_name_is_primitive">is_primitive</a>(self), <a href="type_name.md#0x1_type_name_ENonModuleType">ENonModuleType</a>);
    ...
    <b>let</b> str_bytes = <a href="ascii.md#0x1_ascii_as_bytes">ascii::as_bytes</a>(&self.name);
    <b>let</b> addr_bytes = <a href="vector.md#0x1_vector">vector</a>[];
    <b>let</b> i = 0;
    ...
    <b>while</b> (i &lt; len) {
        <a href="vector.md#0x1_vector_push_back">vector::push_back</a>(
            &<b>mut</b> addr_bytes,
            *<a href="vector.md#0x1_vector_borrow">vector::borrow</a>(str_bytes, i)
        );
        i = i + 1;
    };
...
<pre><code><b>public</b> <b>fun</b> <a href="type_name.md#0x1_type_name_get_module">get_module</a>(self: &<a href="type_name.md#0x1_type_name_TypeName">TypeName</a>): String {
    ...
    <b>let</b> i = <a href="address.md#0x1_address_length">address::length</a>() * 2 + 2;
    <b>let</b> str_bytes = <a href="ascii.md#0x1_ascii_as_bytes">ascii::as_bytes</a>(&self.name);
    <b>let</b> module_name = <a href="vector.md#0x1_vector">vector</a>[];

    <b>loop</b> {
        <b>let</b> char = <a href="vector.md#0x1_vector_borrow">vector::borrow</a>(str_bytes, i);
        <b>if</b> (char != &<a href="type_name.md#0x1_type_name_ASCII_COLON">ASCII_COLON</a>) {
            <a href="vector.md#0x1_vector_push_back">vector::push_back</a>(&<b>mut</b> module_name, *char);
            i = i + 1;
        } <b>else</b> {
            <b>break</b>
        }
