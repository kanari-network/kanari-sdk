...
-  [Function `kari_system_state`](#0x2_object_kari_system_state)
...
-  [Function `kari_deny_list_object_id`](#0x2_object_kari_deny_list_object_id)
...
<a name="0x2_object_KARI_AUTHENTICATOR_STATE_ID"></a>

The hardcoded ID for the singleton AuthenticatorState Object.


<pre><code><b>const</b> <a href="object.md#0x2_object_KARI_AUTHENTICATOR_STATE_ID">KARI_AUTHENTICATOR_STATE_ID</a>: <b>address</b> = 7;
</code></pre>



<a name="0x2_object_KARI_CLOCK_OBJECT_ID"></a>

The hardcoded ID for the singleton Clock Object.


<pre><code><b>const</b> <a href="object.md#0x2_object_KARI_CLOCK_OBJECT_ID">KARI_CLOCK_OBJECT_ID</a>: <b>address</b> = 6;
</code></pre>



<a name="0x2_object_KARI_DENY_LIST_OBJECT_ID"></a>

The hardcoded ID for the singleton DenyList.


<pre><code><b>const</b> <a href="object.md#0x2_object_KARI_DENY_LIST_OBJECT_ID">KARI_DENY_LIST_OBJECT_ID</a>: <b>address</b> = 403;
</code></pre>



<a name="0x2_object_KARI_RANDOM_ID"></a>

The hardcoded ID for the singleton Random Object.


<pre><code><b>const</b> <a href="object.md#0x2_object_KARI_RANDOM_ID">KARI_RANDOM_ID</a>: <b>address</b> = 8;
</code></pre>



<a name="0x2_object_KARI_SYSTEM_STATE_OBJECT_ID"></a>

The hardcoded ID for the singleton kari System State Object.


<pre><code><b>const</b> <a href="object.md#0x2_object_KARI_SYSTEM_STATE_OBJECT_ID">KARI_SYSTEM_STATE_OBJECT_ID</a>: <b>address</b> = 5;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x2_object_id_to_bytes">id_to_bytes</a>(id: &<a href="object.md#0x2_object_ID">ID</a>): <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt; {
    <a href="..\doc\bcs.md#0x1_bcs_to_bytes">bcs::to_bytes</a>(&id.bytes)
}
</code></pre>
...
<a name="0x2_object_kari_system_state"></a>

# Function `kari_system_state`

Create the <code><a href="object.md#0x2_object_UID">UID</a></code> for the singleton <code>kariSystemState</code> object.
This should only be called once from <code>kari_system</code>.


<pre><code><b>fun</b> <a href="object.md#0x2_object_kari_system_state">kari_system_state</a>(ctx: &<a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>): <a href="object.md#0x2_object_UID">object::UID</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="object.md#0x2_object_kari_system_state">kari_system_state</a>(ctx: &TxContext): <a href="object.md#0x2_object_UID">UID</a> {
    ...
    <a href="object.md#0x2_object_UID">UID</a> {
        id: <a href="object.md#0x2_object_ID">ID</a> { bytes: <a href="object.md#0x2_object_KARI_SYSTEM_STATE_OBJECT_ID">KARI_SYSTEM_STATE_OBJECT_ID</a> },
    }
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="clock.md#0x2_clock">clock</a>(): <a href="object.md#0x2_object_UID">UID</a> {
    <a href="object.md#0x2_object_UID">UID</a> {
        id: <a href="object.md#0x2_object_ID">ID</a> { bytes: <a href="object.md#0x2_object_KARI_CLOCK_OBJECT_ID">KARI_CLOCK_OBJECT_ID</a> }
    }
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="authenticator_state.md#0x2_authenticator_state">authenticator_state</a>(): <a href="object.md#0x2_object_UID">UID</a> {
    <a href="object.md#0x2_object_UID">UID</a> {
        id: <a href="object.md#0x2_object_ID">ID</a> { bytes: <a href="object.md#0x2_object_KARI_AUTHENTICATOR_STATE_ID">KARI_AUTHENTICATOR_STATE_ID</a> }
    }
}
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="object.md#0x2_object_randomness_state">randomness_state</a>(): <a href="object.md#0x2_object_UID">UID</a> {
    <a href="object.md#0x2_object_UID">UID</a> {
        id: <a href="object.md#0x2_object_ID">ID</a> { bytes: <a href="object.md#0x2_object_KARI_RANDOM_ID">KARI_RANDOM_ID</a> }
    }
}
</code></pre>
...
# Function `kari_deny_list_object_id`
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="object.md#0x2_object_kari_deny_list_object_id">kari_deny_list_object_id</a>(): <a href="object.md#0x2_object_UID">object::UID</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="object.md#0x2_object_kari_deny_list_object_id">kari_deny_list_object_id</a>(): <a href="object.md#0x2_object_UID">UID</a> {
    <a href="object.md#0x2_object_UID">UID</a> {
        id: <a href="object.md#0x2_object_ID">ID</a> { bytes: <a href="object.md#0x2_object_KARI_DENY_LIST_OBJECT_ID">KARI_DENY_LIST_OBJECT_ID</a> }
    }
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x2_object_uid_to_bytes">uid_to_bytes</a>(uid: &<a href="object.md#0x2_object_UID">UID</a>): <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt; {
    <a href="..\doc\bcs.md#0x1_bcs_to_bytes">bcs::to_bytes</a>(&uid.id.bytes)
}
</code></pre>
...
Create a new object. Returns the <code><a href="object.md#0x2_object_UID">UID</a></code> that must be stored in a kari object.
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x2_object_id_bytes">id_bytes</a>&lt;T: key&gt;(obj: &T): <a href="dependencies/move-stdlib/vector.md#0x1_vector">vector</a>&lt;u8&gt; {
    <a href="..\doc\bcs.md#0x1_bcs_to_bytes">bcs::to_bytes</a>(&<a href="object.md#0x2_object_borrow_uid">borrow_uid</a>(obj).id)
}
</code></pre>
