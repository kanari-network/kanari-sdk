...
<a name="0x2_kari_KA_PER_KARI"></a>

The amount of KA per Kari token based on the the fact that KA is
10^-9 of a Kari token


<pre><code><b>const</b> <a href="kari.md#0x2_kari_KA_PER_KARI">KA_PER_KARI</a>: u64 = 1000000000;
</code></pre>



<a name="0x2_kari_TOTAL_SUPPLY_KA"></a>

The total supply of Kari denominated in KA (100 Million * 10^9)


<pre><code><b>const</b> <a href="kari.md#0x2_kari_TOTAL_SUPPLY_KA">TOTAL_SUPPLY_KA</a>: u64 = 100000000000000000;
</code></pre>
...
<pre><code><b>const</b> <a href="kari.md#0x2_kari_TOTAL_SUPPLY_KARI">TOTAL_SUPPLY_KARI</a>: u64 = 100000000;
</code></pre>
...
<pre><code><b>fun</b> <a href="kari.md#0x2_kari_new">new</a>(ctx: &<b>mut</b> TxContext): Balance&lt;<a href="kari.md#0x2_kari_KARI">KARI</a>&gt; {
    ...
    <b>let</b> (treasury, <a href="metadata.md#0x2_metadata">metadata</a>) = <a href="coin.md#0x2_coin_create_currency">coin::create_currency</a>(
    ...
    <a href="transfer.md#0x2_transfer_public_freeze_object">transfer::public_freeze_object</a>(<a href="metadata.md#0x2_metadata">metadata</a>);
    <b>let</b> supply = <a href="coin.md#0x2_coin_treasury_into_supply">coin::treasury_into_supply</a>(treasury);
    <b>let</b> total_kari = <a href="balance.md#0x2_balance_increase_supply">balance::increase_supply</a>(&<b>mut</b> supply, <a href="kari.md#0x2_kari_TOTAL_SUPPLY_KA">TOTAL_SUPPLY_KA</a>);
...
<pre><code><b>public</b> entry <b>fun</b> <a href="kari.md#0x2_kari_burn">burn</a>(treasury_cap: &<b>mut</b> <a href="coin.md#0x2_coin_TreasuryCap">coin::TreasuryCap</a>&lt;<a href="kari.md#0x2_kari_KARI">kari::KARI</a>&gt;, <a href="coin.md#0x2_coin">coin</a>: <a href="coin.md#0x2_coin_Coin">coin::Coin</a>&lt;<a href="kari.md#0x2_kari_KARI">kari::KARI</a>&gt;)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="kari.md#0x2_kari_burn">burn</a>(treasury_cap: &<b>mut</b> TreasuryCap&lt;<a href="kari.md#0x2_kari_KARI">KARI</a>&gt;, <a href="coin.md#0x2_coin">coin</a>: Coin&lt;<a href="kari.md#0x2_kari_KARI">KARI</a>&gt;) {
