...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_create_currency">create_currency</a>&lt;T: drop&gt;(
    ...
    <b>assert</b>!(kanari_framework::types::is_one_time_witness(&witness), <a href="coin.md#0x2_coin_EBadWitness">EBadWitness</a>);
...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_create_regulated_currency">create_regulated_currency</a>&lt;T: drop&gt;(
    ...
    <b>let</b> (treasury_cap, <a href="metadata.md#0x2_metadata">metadata</a>) = <a href="coin.md#0x2_coin_create_currency">create_currency</a>(
        witness,
        decimals,
        symbol,
        name,
    ...
    <a href="transfer.md#0x2_transfer_freeze_object">transfer::freeze_object</a>(<a href="coin.md#0x2_coin_RegulatedCoinMetadata">RegulatedCoinMetadata</a>&lt;T&gt; {
        id: <a href="object.md#0x2_object_new">object::new</a>(ctx),
        coin_metadata_object: <a href="object.md#0x2_object_id">object::id</a>(&<a href="metadata.md#0x2_metadata">metadata</a>),
        deny_cap_object: <a href="object.md#0x2_object_id">object::id</a>(&deny_cap),
    });
    (treasury_cap, deny_cap, <a href="metadata.md#0x2_metadata">metadata</a>)
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_deny_list_contains">deny_list_contains</a>&lt;T&gt;(
    ...
    <b>let</b> type_str = <a href="dependencies/move-stdlib/type_name.md#0x1_type_name_into_string">type_name::into_string</a>(<a href="dependencies/move-stdlib/type_name.md#0x1_type_name_get_with_original_ids">type_name::get_with_original_ids</a>&lt;T&gt;());

    // Check <b>if</b> type is a primitive type - in which case it can't be a <a href="coin.md#0x2_coin">coin</a>
    <b>if</b> (type_str == <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_string">ascii::string</a>(b"bool") ||
        type_str == <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_string">ascii::string</a>(b"u8") ||
        type_str == <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_string">ascii::string</a>(b"u64") ||
        type_str == <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_string">ascii::string</a>(b"u128") ||
        type_str == <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_string">ascii::string</a>(b"<b>address</b>") ||
        type_str == <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_string">ascii::string</a>(b"signer")) {
        <b>return</b> <b>false</b>
    };

    <b>let</b> type = <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_into_bytes">ascii::into_bytes</a>(type_str);
...
<pre><code><b>public</b> entry <b>fun</b> <a href="coin.md#0x2_coin_update_name">update_name</a>&lt;T&gt;(_treasury: &<a href="coin.md#0x2_coin_TreasuryCap">coin::TreasuryCap</a>&lt;T&gt;, <a href="metadata.md#0x2_metadata">metadata</a>: &<b>mut</b> <a href="coin.md#0x2_coin_CoinMetadata">coin::CoinMetadata</a>&lt;T&gt;, name: <a href="dependencies/move-stdlib/string.md#0x1_string_String">string::String</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="coin.md#0x2_coin_update_name">update_name</a>&lt;T&gt;(
    _treasury: &<a href="coin.md#0x2_coin_TreasuryCap">TreasuryCap</a>&lt;T&gt;, <a href="metadata.md#0x2_metadata">metadata</a>: &<b>mut</b> <a href="coin.md#0x2_coin_CoinMetadata">CoinMetadata</a>&lt;T&gt;, name: <a href="dependencies/move-stdlib/string.md#0x1_string_String">string::String</a>
) {
    <a href="metadata.md#0x2_metadata">metadata</a>.name = name;
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="coin.md#0x2_coin_update_symbol">update_symbol</a>&lt;T&gt;(_treasury: &<a href="coin.md#0x2_coin_TreasuryCap">coin::TreasuryCap</a>&lt;T&gt;, <a href="metadata.md#0x2_metadata">metadata</a>: &<b>mut</b> <a href="coin.md#0x2_coin_CoinMetadata">coin::CoinMetadata</a>&lt;T&gt;, symbol: <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_String">ascii::String</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="coin.md#0x2_coin_update_symbol">update_symbol</a>&lt;T&gt;(
    _treasury: &<a href="coin.md#0x2_coin_TreasuryCap">TreasuryCap</a>&lt;T&gt;, <a href="metadata.md#0x2_metadata">metadata</a>: &<b>mut</b> <a href="coin.md#0x2_coin_CoinMetadata">CoinMetadata</a>&lt;T&gt;, symbol: <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_String">ascii::String</a>
) {
    <a href="metadata.md#0x2_metadata">metadata</a>.symbol = symbol;
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="coin.md#0x2_coin_update_description">update_description</a>&lt;T&gt;(_treasury: &<a href="coin.md#0x2_coin_TreasuryCap">coin::TreasuryCap</a>&lt;T&gt;, <a href="metadata.md#0x2_metadata">metadata</a>: &<b>mut</b> <a href="coin.md#0x2_coin_CoinMetadata">coin::CoinMetadata</a>&lt;T&gt;, description: <a href="dependencies/move-stdlib/string.md#0x1_string_String">string::String</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="coin.md#0x2_coin_update_description">update_description</a>&lt;T&gt;(
    _treasury: &<a href="coin.md#0x2_coin_TreasuryCap">TreasuryCap</a>&lt;T&gt;, <a href="metadata.md#0x2_metadata">metadata</a>: &<b>mut</b> <a href="coin.md#0x2_coin_CoinMetadata">CoinMetadata</a>&lt;T&gt;, description: <a href="dependencies/move-stdlib/string.md#0x1_string_String">string::String</a>
) {
    <a href="metadata.md#0x2_metadata">metadata</a>.description = description;
}
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="coin.md#0x2_coin_update_icon_url">update_icon_url</a>&lt;T&gt;(_treasury: &<a href="coin.md#0x2_coin_TreasuryCap">coin::TreasuryCap</a>&lt;T&gt;, <a href="metadata.md#0x2_metadata">metadata</a>: &<b>mut</b> <a href="coin.md#0x2_coin_CoinMetadata">coin::CoinMetadata</a>&lt;T&gt;, <a href="url.md#0x2_url">url</a>: <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_String">ascii::String</a>)
</code></pre>
...
<pre><code><b>public</b> entry <b>fun</b> <a href="coin.md#0x2_coin_update_icon_url">update_icon_url</a>&lt;T&gt;(
    _treasury: &<a href="coin.md#0x2_coin_TreasuryCap">TreasuryCap</a>&lt;T&gt;, <a href="metadata.md#0x2_metadata">metadata</a>: &<b>mut</b> <a href="coin.md#0x2_coin_CoinMetadata">CoinMetadata</a>&lt;T&gt;, <a href="url.md#0x2_url">url</a>: <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_String">ascii::String</a>
) {
    <a href="metadata.md#0x2_metadata">metadata</a>.icon_url = <a href="dependencies/move-stdlib/option.md#0x1_option_some">option::some</a>(<a href="url.md#0x2_url_new_unsafe">url::new_unsafe</a>(<a href="url.md#0x2_url">url</a>));
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_get_decimals">get_decimals</a>&lt;T&gt;(<a href="metadata.md#0x2_metadata">metadata</a>: &<a href="coin.md#0x2_coin_CoinMetadata">coin::CoinMetadata</a>&lt;T&gt;): u8
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_get_decimals">get_decimals</a>&lt;T&gt;(<a href="metadata.md#0x2_metadata">metadata</a>: &<a href="coin.md#0x2_coin_CoinMetadata">CoinMetadata</a>&lt;T&gt;): u8 {
    <a href="metadata.md#0x2_metadata">metadata</a>.decimals
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_get_name">get_name</a>&lt;T&gt;(<a href="metadata.md#0x2_metadata">metadata</a>: &<a href="coin.md#0x2_coin_CoinMetadata">coin::CoinMetadata</a>&lt;T&gt;): <a href="dependencies/move-stdlib/string.md#0x1_string_String">string::String</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_get_name">get_name</a>&lt;T&gt;(<a href="metadata.md#0x2_metadata">metadata</a>: &<a href="coin.md#0x2_coin_CoinMetadata">CoinMetadata</a>&lt;T&gt;): <a href="dependencies/move-stdlib/string.md#0x1_string_String">string::String</a> {
    <a href="metadata.md#0x2_metadata">metadata</a>.name
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_get_symbol">get_symbol</a>&lt;T&gt;(<a href="metadata.md#0x2_metadata">metadata</a>: &<a href="coin.md#0x2_coin_CoinMetadata">coin::CoinMetadata</a>&lt;T&gt;): <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_String">ascii::String</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_get_symbol">get_symbol</a>&lt;T&gt;(<a href="metadata.md#0x2_metadata">metadata</a>: &<a href="coin.md#0x2_coin_CoinMetadata">CoinMetadata</a>&lt;T&gt;): <a href="dependencies/move-stdlib/ascii.md#0x1_ascii_String">ascii::String</a> {
    <a href="metadata.md#0x2_metadata">metadata</a>.symbol
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_get_description">get_description</a>&lt;T&gt;(<a href="metadata.md#0x2_metadata">metadata</a>: &<a href="coin.md#0x2_coin_CoinMetadata">coin::CoinMetadata</a>&lt;T&gt;): <a href="dependencies/move-stdlib/string.md#0x1_string_String">string::String</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_get_description">get_description</a>&lt;T&gt;(<a href="metadata.md#0x2_metadata">metadata</a>: &<a href="coin.md#0x2_coin_CoinMetadata">CoinMetadata</a>&lt;T&gt;): <a href="dependencies/move-stdlib/string.md#0x1_string_String">string::String</a> {
    <a href="metadata.md#0x2_metadata">metadata</a>.description
}
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_get_icon_url">get_icon_url</a>&lt;T&gt;(<a href="metadata.md#0x2_metadata">metadata</a>: &<a href="coin.md#0x2_coin_CoinMetadata">coin::CoinMetadata</a>&lt;T&gt;): <a href="dependencies/move-stdlib/option.md#0x1_option_Option">option::Option</a>&lt;<a href="url.md#0x2_url_Url">url::Url</a>&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="coin.md#0x2_coin_get_icon_url">get_icon_url</a>&lt;T&gt;(<a href="metadata.md#0x2_metadata">metadata</a>: &<a href="coin.md#0x2_coin_CoinMetadata">CoinMetadata</a>&lt;T&gt;): Option&lt;Url&gt; {
    <a href="metadata.md#0x2_metadata">metadata</a>.icon_url
}
</code></pre>
