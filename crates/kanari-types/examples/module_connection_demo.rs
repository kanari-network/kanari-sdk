...
fn main() {
    ...
    let addr =
        move_core_types::account_address::AccountAddress::from_hex_literal("0xabcd").unwrap();
    let tx_ctx =
        tx_context::TxContextRecord::from_address(addr, tx_hash.clone(), 100, 1_650_000_000, 50);
