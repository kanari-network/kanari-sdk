...
module kanari_system::ecdsa_r1 {
    ...
    public fun verify(
        ...
        assert!(
            vector::length(public_key) == ECDSA_R1_COMPRESSED_PUBKEY_LENGTH,
            ErrorInvalidPubKey
        );
    ...
    fun test_verify_success() {
        ...
        let pubkey =
            x"0258a618066814098f8ddb3cbde73838b59028d843958031e50be0a5f4b0a9796d";
        // This is a valid P-256 signature for the message
        let sig =
            x"74133905657c1992d8d6bd72ffa7ccf8d2adf3e4a3ca25f8dc8eec175752cb5a40459f71b549a25cba3cddf4157e946bbff7b18fc82774e9c4c54e362b97ccb5";
