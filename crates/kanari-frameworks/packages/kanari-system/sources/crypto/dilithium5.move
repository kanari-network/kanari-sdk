...
module kanari_system::dilithium5 {
    const PUBLIC_KEY_LENGTH: u64 = 2592;
    const SIGNATURE_LENGTH: u64 = 4595;
    ...
    #[test]
    fun test_sizes() {
        assert!(public_key_length() == 2592, 0);
        assert!(signature_length() == 4595, 1);
    }
