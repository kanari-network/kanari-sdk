...
use simulation::{blockchain::{BALANCES, BLOCKCHAIN}, chain_id::CHAIN_ID};
...
fn send_transaction(params: Params) -> JsonRpcResult<JsonValue> {
    ...
    let amount: u64 = params.get("amount").and_then(|v| v.as_u64()).ok_or(JsonRpcError::invalid_params("Missing or invalid 'amount' parameter"))?;
