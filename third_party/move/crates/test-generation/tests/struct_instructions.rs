...
use move_binary_format::file_format::{
    Ability, AbilitySet, Bytecode, CompiledModule, FieldDefinition, FieldHandle, FieldHandleIndex,
    IdentifierIndex, ModuleHandleIndex, SignatureToken, StructDefinition, StructDefinitionIndex,
