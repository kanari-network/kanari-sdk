...
module kanari_framework::display {
    use kanari_framework::package::{from_package, Publisher};
    use kanari_framework::tx_context::{sender, TxContext};
    use kanari_framework::vec_map::{Self, VecMap};
    ...
    /// the discovery.
    ///
    /// Since kanari_framework RPC supports querying events by type, finding a Display for the T
...
#[test_only]
module kanari_framework::display_tests {
    use kanari_framework::object::UID;
    use kanari_framework::test_scenario as test;
    use kanari_framework::transfer;
