#[allow(unused_const)]
/// In addition to the fields declared in its type definition, a kanari_framework object can have dynamic fields
...
/// This gives kanari_framework programmers the flexibility to extend objects on-the-fly, and it also serves as a
/// building block for core collection types
module kanari_framework::dynamic_field {
